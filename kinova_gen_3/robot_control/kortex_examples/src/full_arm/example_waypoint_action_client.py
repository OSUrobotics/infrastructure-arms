        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.439, 0.194, 0.448, math.radians(90.6), math.radians(-1.0), math.radians(150), 0
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.200, 0.150, 0.400, math.radians(90.6), math.radians(-1.0), math.radians(150), 0
                )
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(
                    0.350, 0.050, 0.300, math.radians(90.6), math.radians(-1.0), math.radians(150), 0
                )
            )
        else:
            goal.trajectory.append(self.FillCartesianWaypoint(0.7, 0.0, 0.5, math.radians(90), 0, math.radians(90), 0))
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.7, 0.0, 0.33, math.radians(90), 0, math.radians(90), 0.1)
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.7, 0.48, 0.33, math.radians(90), 0, math.radians(90), 0.1)
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.61, 0.22, 0.4, math.radians(90), 0, math.radians(90), 0.1)
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.7, 0.48, 0.33, math.radians(90), 0, math.radians(90), 0.1)
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.63, -0.22, 0.45, math.radians(90), 0, math.radians(90), 0.1)
            )
            goal.trajectory.append(
                self.FillCartesianWaypoint(0.65, 0.05, 0.45, math.radians(90), 0, math.radians(90), 0)
            )
