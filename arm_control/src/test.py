...
if __name__ == '__main__':
    ...
    blank = [0.212322831154, -0.257197618484, 0.509646713734]
    ugh = EulerXYZ2Quaternion([1.63771402836, 1.11316478252, 0.134094119072])
    pose_mq = [0.212322831154, -0.257197618484, 0.709646713734, ugh[0], ugh[1], ugh[2], ugh[3]]
