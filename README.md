...
roslaunch infrastructure_flexbe_behaviors start_test.launch collect_data:=true name:=grasp_dataset_drawer_z_rot_0 video:=true robot_jointState_topic:=/j2s7s300_driver/out/joint_state
