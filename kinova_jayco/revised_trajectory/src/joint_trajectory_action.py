...
class JointTrajectoryAction(object):
    ...
    def __init__(self, name):
        ...
        self.joint_client = actionlib.SimpleActionClient(action_address, kinova_msgs.msg.ArmJointAnglesAction)
        ...
        self.index = 1
        self.goal_contsraint = 0.05  # Tolerance from the goal allowed in degrees
    ...
    def execute_cb(self, goal):
        ...
        for i in range(len(self.trajectory_time) - 1):
            ...
            max_state_update_time_before_cancel = 0.25
            ...
            while True:
                ...
                # For joint1
                if joint_status[0] == True or (
                    (isclose(direction[0], 1.0) and error[0] < self.goal_contsraint)
                    or (isclose(direction[0], -1.0) and error[0] > -self.goal_contsraint)
                ):
    ...
    def parse_trajectory(self, trajectory):
        ...
        for i in range(num_poses):
            ...
            positions = [
                trajectory.trajectory.points[i].positions[0] * 180 / pi,
